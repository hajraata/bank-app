...
btnTransfer.addEventListener('click', function (e) {
  ...
  if (
    amountToTransfer >= 0 &&
    transferAmountTo &&
    currentAcc.balance >= amountToTransfer &&
    transferAmountTo?.username !== currentAcc.username
  ) {
    currentAcc.movements.push(-amountToTransfer);
    transferAmountTo.movements.push(+amountToTransfer);
...
btnLoan.addEventListener('click', function (e) {
  ...
  if (
    amountToLoan > 0 &&
    currentAcc.movements.some(mov => mov >= 0.1 * amountToLoan)
  ) {
    setTimeout(function () {
